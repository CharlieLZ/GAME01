...
const gameUrl= "/game/192337/index.html"
...
export default async function Home() {
    ...
    return (
        <div className="max-w-6xl mx-auto px-4 py-8 space-y-16 text-gray-800">
            ...
            <section id="hero" className="text-center bg-gradient-to-r from-teal-600 to-cyan-600 p-5 rounded-xl shadow-lg">
            ...
            <section id="screenshots" className="bg-white p-6 rounded-xl shadow-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <Image src="/img/s11080.jpg" alt="Fast Food Simulator Game Screenshot 1" width={400} height={300} className="rounded-lg" />
                    <Image src="/img/s21080.jpg" alt="Fast Food Simulator Game Screenshot 2" width={400} height={300} className="rounded-lg" />
                    <Image src="/img/s31080.jpg" alt="Fast Food Simulator Game Screenshot 3" width={400} height={300} className="rounded-lg" />
                </div>
            </section>
